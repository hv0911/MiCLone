...
import '../Stylesheets/Prefooter1.css';



const loop = <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z" /></svg>
...
// const angle =<svg xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M18.75 36 16.6 33.85 26.5 23.95 16.6 14.05 18.75 11.9 30.8 23.95Z"/></svg>
    ...
    return (
        <div className='main'>
            ...
            <div className='Prefooter2'>
                ...
                <div >
                    <input type="text" id='chatbox' placeholder='ENTER EMAIL ADDRESS' /> {/*<button id='btn'>&gt; </button> */}
                </div>
                <div>
                    <h2>FOLLOW MI</h2>
            ...
            <div className='footer'>
                <div>
                    ...
                    {support.map((item, index) => {
                        return (
                            <Foot key={index} name={item.name} url={item.name} />
                        )
                    })}
                </div>
                ...
                <div>
                    ...
                    <button className='chat_btn' >CHAT NOW</button>
                </div>
